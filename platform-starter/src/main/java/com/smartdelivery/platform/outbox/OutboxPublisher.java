 ...
 * written by each service's own {@code *EventPublisher} -- in the same transaction as
 * the state change they describe -- and actually sends them to Kafka, out of band from
 * the request/consumer thread that wrote them.
 *
