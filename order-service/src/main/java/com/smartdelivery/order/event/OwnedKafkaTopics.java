...
/**
 * The topics order-service publishes to, and therefore owns (Phase 23, ADR 015): declared
...
public class OwnedKafkaTopics {
    ...
    public KafkaAdmin.NewTopics declaredKafkaTopics(OwnedTopics topics) {
        return topics.declare(KafkaTopics.ORDER_CREATED, KafkaTopics.ORDER_CANCELLED, KafkaTopics.ORDER_FAILED);
    }
}
