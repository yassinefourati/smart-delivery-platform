...
class OutboxPublisherTest {
    ...
    private OutboxEvent pendingEvent(UUID aggregateId, String payload) {
        OutboxEvent event = new OutboxEvent("Shipment", aggregateId, "ShipmentCreated", KafkaTopics.SHIPMENT_CREATED, payload);
    ...
    void publishPendingMarksARowPublishedOnASuccessfulSend() {
        ...
        assertThat(meterRegistry.counter(OutboxMetrics.PUBLISHED, "eventType", "ShipmentCreated").count()).isEqualTo(1);
    }
    ...
    void publishPendingLeavesARowPendingAndRecordsTheErrorWhenTheSendFails() {
        ...
        verify(outboxEventRepository).save(event);
        assertThat(meterRegistry.counter(OutboxMetrics.PUBLISH_FAILURES, "eventType", "ShipmentCreated").count())
                .isEqualTo(1);
    }
