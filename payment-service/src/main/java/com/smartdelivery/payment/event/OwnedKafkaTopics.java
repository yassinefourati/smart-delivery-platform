...
/**
 * The topics payment-service publishes to, and therefore owns (Phase 23, ADR 015): declared
...
public class OwnedKafkaTopics {
    ...
    public KafkaAdmin.NewTopics declaredKafkaTopics(OwnedTopics topics) {
        return topics.declare(KafkaTopics.PAYMENT_COMPLETED, KafkaTopics.PAYMENT_FAILED);
    }
}
